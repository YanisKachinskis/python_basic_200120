...
class Road:
    ...
    def weight_calculation(self, thickness):
        mass = (self._length * self._width * self._weight_sqr_meter * thickness) / 1000
        print(f"Масса асфальта всего дорожного полотна равна {mass} тонн.")


m95 = Road(5000, 20)
m95.weight_calculation(5)
